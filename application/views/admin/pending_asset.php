          ...
          <div class="box-header">
            <div class="row">
              <div class="col-md-10">
                ...
                <p>Aset pending merupakan yang tidak bisa digunakan, biasanya karena Sedang di service atau lagi maintenance</p>
              </div>
              <div class="col-md-2">
                <div class="btn-group">
                  <a href="<?php echo base_url('index.php/asset/PrintPendingAsset'); ?>" type="button" class="btn btn-default"><i class='fa fa-print'></i> Cetak</a>
