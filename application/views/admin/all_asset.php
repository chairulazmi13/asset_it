  ...
  <section class="content container-fluid">
    ...
    <div class="box">
          <div class="box-header">
            <div class="row">
              <div class="col-md-10">
               <h3 class="box-title">Data Seluruh Asset</h3>
               <p>Data yang ditampilkan hanya yang berstatus digunakan, siap digunakan, dan pending</p>
              </div>
              <div class="col-md-2">
                <div class="btn-group">
                  <a href="<?php echo base_url('index.php/asset/PrintAllAsset');?>" target="_blank" type="button" class="btn btn-default"><i class='fa fa-print'></i> Cetak</a>
          ...
          <div class="box-body table-responsive">
            <table id="example1" class="table table-striped stable-responsive table-no-bordered" style="width:100%">
              <thead>
              <tr>
                <th>Asset</th>
                <th>Model</th>
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url('index.php/user/detail/').$row->username; ?>"><?php  echo $row->nama;  ?></a></td>
              <td>
