  ...
  <section class="content container-fluid">
    ...
    <div class="box">
          <div class="box-header">
            <div class="row">
              <div class="col-md-10">
               <h3 class="box-title">Data Digunakan</h3>
               <p>Data yang ditampilkan hanya yang berstatus digunakan</p>
              </div>
              <div class="col-md-2">
                <div class="btn-group">
                  <a href="<?php echo base_url('index.php/asset/PrintDeployAsset'); ?>" target="_blank" type="button" class="btn btn-default"><i class='fa fa-print'></i> Cetak</a>
