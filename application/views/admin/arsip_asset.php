  ...
  <section class="content container-fluid">
    ...
    <div class="box">
          <div class="box-header">
            <div class="row">
              <div class="col-md-10">
                <h3 class="box-title">Data Asset Pending</h3>
                <p>Aset Arsip merupakan asset yang sudah tidak bisa dipakai lagi, bisa karena rusak atau Hilang</p>
              </div>
              <div class="col-md-2">
                <div class="btn-group">
                  <a href="<?php echo base_url('index.php/asset/PrintArsipAsset'); ?>" type="button" class="btn btn-default" target="_blank"><i class='fa fa-print'></i> Cetak</a>
                  ...
                  <?php
                    ...
                    if ($tipe == "pending") {
                      ...
                      echo " <span class='label label-success'>Digunakan</span>";
                        ...
                        echo $row->nama_status;
                        echo " <span class='label label-danger'>Diarsipkan</span>";
                    }
                  ?>
                </td>
